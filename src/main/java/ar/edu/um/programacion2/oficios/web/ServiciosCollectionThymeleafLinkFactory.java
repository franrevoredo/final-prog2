...
@Component
/**
 * = ServiciosCollectionThymeleafLinkFactory
 *
 * TODO Auto-generated class documentation
 *
 */
@RooLinkFactory(controller = ServiciosCollectionThymeleafController.class)
public class ServiciosCollectionThymeleafLinkFactory implements MethodLinkFactory<ServiciosCollectionThymeleafController> {
     ...
     * @return Class
     */
    public Class<ServiciosCollectionThymeleafController> getControllerClass() {
