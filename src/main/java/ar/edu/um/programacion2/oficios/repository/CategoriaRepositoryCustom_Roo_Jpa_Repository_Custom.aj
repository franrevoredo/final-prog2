...
privileged aspect CategoriaRepositoryCustom_Roo_Jpa_Repository_Custom {
     ...
     * @return Page
     */
    public abstract Page<Categoria> CategoriaRepositoryCustom.findAll(GlobalSearch globalSearch, Pageable pageable);
