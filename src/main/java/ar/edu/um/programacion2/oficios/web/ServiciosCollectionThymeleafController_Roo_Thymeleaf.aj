...
privileged aspect ServiciosCollectionThymeleafController_Roo_Thymeleaf {
    
    declare @type: ServiciosCollectionThymeleafController: @Controller;
    
    declare @type: ServiciosCollectionThymeleafController: @RequestMapping(value = "/servicios", name = "ServiciosCollectionThymeleafController", produces = MediaType.TEXT_HTML_VALUE);
    
    /**
     * TODO Auto-generated attribute documentation
     * 
     */
    private MessageSource ServiciosCollectionThymeleafController.messageSource;
    
    /**
     * TODO Auto-generated attribute documentation
     * 
     */
    private MethodLinkBuilderFactory<ServiciosItemThymeleafController> ServiciosCollectionThymeleafController.itemLink;
    
    /**
     * TODO Auto-generated attribute documentation
     * 
     */
    private ConversionService ServiciosCollectionThymeleafController.conversionService;
     ...
     */
    @Autowired
    public ServiciosCollectionThymeleafController.new(ServicioService servicioService, ConversionService conversionService, MessageSource messageSource, ControllerMethodLinkBuilderFactory linkBuilder) {
     ...
     */
    public MessageSource ServiciosCollectionThymeleafController.getMessageSource() {
        return messageSource;
    }
     ...
     * @param messageSource
     */
    public void ServiciosCollectionThymeleafController.setMessageSource(MessageSource messageSource) {
     ...
     */
    public MethodLinkBuilderFactory<ServiciosItemThymeleafController> ServiciosCollectionThymeleafController.getItemLink() {
        return itemLink;
    }
     ...
     * @param itemLink
     */
    public void ServiciosCollectionThymeleafController.setItemLink(MethodLinkBuilderFactory<ServiciosItemThymeleafController> itemLink) {
     ...
     */
    public ConversionService ServiciosCollectionThymeleafController.getConversionService() {
        return conversionService;
    }
     ...
     * @param conversionService
     */
    public void ServiciosCollectionThymeleafController.setConversionService(ConversionService conversionService) {
    ...
    public ModelAndView ServiciosCollectionThymeleafController.list(Model model) {
    ...
    @ResponseBody
    public ResponseEntity<ConvertedDatatablesData<Servicio>> ServiciosCollectionThymeleafController.datatables(DatatablesColumns datatablesColumns, GlobalSearch search, DatatablesPageable pageable, @RequestParam("draw") Integer draw) {
    ...
    @ResponseBody
    public ResponseEntity<Select2DataSupport<Servicio>> ServiciosCollectionThymeleafController.select2(GlobalSearch search, Pageable pageable, Locale locale) {
        Page<Servicio> servicios = getServicioService().findAll(search, pageable);
     ...
     */
    @InitBinder("servicio")
    public void ServiciosCollectionThymeleafController.initServicioBinder(WebDataBinder dataBinder) {
     ...
     * @param model
     */
    public void ServiciosCollectionThymeleafController.populateFormats(Model model) {
     ...
     * @param model
     */
    public void ServiciosCollectionThymeleafController.populateForm(Model model) {
    ...
    public ModelAndView ServiciosCollectionThymeleafController.createForm(Model model) {
        populateForm(model);
    ...
    @ResponseBody
    public ResponseEntity<?> ServiciosCollectionThymeleafController.deleteBatch(@PathVariable("ids") Collection<Long> ids) {
     ...
     */
    public void ServiciosCollectionThymeleafController.export(GlobalSearch search, @PageableDefault(size = 2147483647) Pageable pageable, String[] datatablesColumns, HttpServletResponse response, JasperReportsExporter exporter, String fileName, Locale locale) {
    ...
    @ResponseBody
    public ResponseEntity<?> ServiciosCollectionThymeleafController.exportCsv(GlobalSearch search, @PageableDefault(size = 2147483647) Pageable pageable, @RequestParam("datatablesColumns") String[] datatablesColumns, HttpServletResponse response, Locale locale) {
    ...
    @ResponseBody
    public ResponseEntity<?> ServiciosCollectionThymeleafController.exportPdf(GlobalSearch search, @PageableDefault(size = 2147483647) Pageable pageable, @RequestParam("datatablesColumns") String[] datatablesColumns, HttpServletResponse response, Locale locale) {
    ...
    @ResponseBody
    public ResponseEntity<?> ServiciosCollectionThymeleafController.exportXls(GlobalSearch search, @PageableDefault(size = 2147483647) Pageable pageable, @RequestParam("datatablesColumns") String[] datatablesColumns, HttpServletResponse response, Locale locale) {
     ...
     */
    public void ServiciosCollectionThymeleafController.addColumnToReportBuilder(String columnName, FastReportBuilder builder, Locale locale, String fileName) {
        try {
