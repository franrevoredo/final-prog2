...
privileged aspect ClientesCollectionThymeleafController_Roo_Thymeleaf {
     ...
     */
    @InitBinder("cliente")
    public void ClientesCollectionThymeleafController.initClienteBinder(WebDataBinder dataBinder) {
    ...
    public void ClientesCollectionThymeleafController.addColumnToReportBuilder(String columnName, FastReportBuilder builder, Locale locale, String fileName) {
        ...
        else if (columnName.equals("domicilio")) {
            builder.addColumn(getMessageSource().getMessage("label_cliente_domicilio", null, "Domicilio", locale), "domicilio", String.class.getName(), 100);
        }
        else if (columnName.equals("domicilio2")) {
            builder.addColumn(getMessageSource().getMessage("label_cliente_domicilio2", null, "Domicilio 2", locale), "domicilio2", String.class.getName(), 100);
        }
        }
