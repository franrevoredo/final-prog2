...
privileged aspect CalificacionClientesCollectionThymeleafController_Roo_Thymeleaf {
    
    declare @type: CalificacionClientesCollectionThymeleafController: @Controller;
    
    declare @type: CalificacionClientesCollectionThymeleafController: @RequestMapping(value = "/calificacionclientes", name = "CalificacionClientesCollectionThymeleafController", produces = MediaType.TEXT_HTML_VALUE);
    
    /**
     * TODO Auto-generated attribute documentation
     * 
     */
    private MessageSource CalificacionClientesCollectionThymeleafController.messageSource;
    
    /**
     * TODO Auto-generated attribute documentation
     * 
     */
    private MethodLinkBuilderFactory<CalificacionClientesItemThymeleafController> CalificacionClientesCollectionThymeleafController.itemLink;
    
    /**
     * TODO Auto-generated attribute documentation
     * 
     */
    private ConversionService CalificacionClientesCollectionThymeleafController.conversionService;
     ...
     */
    @Autowired
    public CalificacionClientesCollectionThymeleafController.new(CalificacionClienteService calificacionClienteService, ConversionService conversionService, MessageSource messageSource, ControllerMethodLinkBuilderFactory linkBuilder) {
     ...
     */
    public MessageSource CalificacionClientesCollectionThymeleafController.getMessageSource() {
        return messageSource;
    }
     ...
     * @param messageSource
     */
    public void CalificacionClientesCollectionThymeleafController.setMessageSource(MessageSource messageSource) {
     ...
     */
    public MethodLinkBuilderFactory<CalificacionClientesItemThymeleafController> CalificacionClientesCollectionThymeleafController.getItemLink() {
        return itemLink;
    }
     ...
     * @param itemLink
     */
    public void CalificacionClientesCollectionThymeleafController.setItemLink(MethodLinkBuilderFactory<CalificacionClientesItemThymeleafController> itemLink) {
     ...
     */
    public ConversionService CalificacionClientesCollectionThymeleafController.getConversionService() {
        return conversionService;
    }
     ...
     * @param conversionService
     */
    public void CalificacionClientesCollectionThymeleafController.setConversionService(ConversionService conversionService) {
    ...
    public ModelAndView CalificacionClientesCollectionThymeleafController.list(Model model) {
    ...
    @ResponseBody
    public ResponseEntity<ConvertedDatatablesData<CalificacionCliente>> CalificacionClientesCollectionThymeleafController.datatables(DatatablesColumns datatablesColumns, GlobalSearch search, DatatablesPageable pageable, @RequestParam("draw") Integer draw) {
    ...
    @ResponseBody
    public ResponseEntity<Select2DataSupport<CalificacionCliente>> CalificacionClientesCollectionThymeleafController.select2(GlobalSearch search, Pageable pageable, Locale locale) {
        Page<CalificacionCliente> calificacionClientes = getCalificacionClienteService().findAll(search, pageable);
    ...
    public void CalificacionClientesCollectionThymeleafController.initCalificacionClienteBinder(WebDataBinder dataBinder) {
     ...
     * @param model
     */
    public void CalificacionClientesCollectionThymeleafController.populateFormats(Model model) {
     ...
     * @param model
     */
    public void CalificacionClientesCollectionThymeleafController.populateForm(Model model) {
    ...
    public ModelAndView CalificacionClientesCollectionThymeleafController.create(@Valid @ModelAttribute CalificacionCliente calificacionCliente, BindingResult result, Model model) {
        if (result.hasErrors()) {
            populateForm(model);
        ...
        UriComponents showURI = getItemLink().to(CalificacionClientesItemThymeleafLinkFactory.SHOW).with("calificacionCliente", newCalificacionCliente.getId()).toUri();
    ...
    public ModelAndView CalificacionClientesCollectionThymeleafController.createForm(Model model) {
        populateForm(model);
    ...
    @ResponseBody
    public ResponseEntity<?> CalificacionClientesCollectionThymeleafController.deleteBatch(@PathVariable("ids") Collection<Long> ids) {
     ...
     */
    public void CalificacionClientesCollectionThymeleafController.export(GlobalSearch search, @PageableDefault(size = 2147483647) Pageable pageable, String[] datatablesColumns, HttpServletResponse response, JasperReportsExporter exporter, String fileName, Locale locale) {
    ...
    @ResponseBody
    public ResponseEntity<?> CalificacionClientesCollectionThymeleafController.exportCsv(GlobalSearch search, @PageableDefault(size = 2147483647) Pageable pageable, @RequestParam("datatablesColumns") String[] datatablesColumns, HttpServletResponse response, Locale locale) {
    ...
    @ResponseBody
    public ResponseEntity<?> CalificacionClientesCollectionThymeleafController.exportPdf(GlobalSearch search, @PageableDefault(size = 2147483647) Pageable pageable, @RequestParam("datatablesColumns") String[] datatablesColumns, HttpServletResponse response, Locale locale) {
    ...
    @ResponseBody
    public ResponseEntity<?> CalificacionClientesCollectionThymeleafController.exportXls(GlobalSearch search, @PageableDefault(size = 2147483647) Pageable pageable, @RequestParam("datatablesColumns") String[] datatablesColumns, HttpServletResponse response, Locale locale) {
     ...
     */
    public void CalificacionClientesCollectionThymeleafController.addColumnToReportBuilder(String columnName, FastReportBuilder builder, Locale locale, String fileName) {
        try {
